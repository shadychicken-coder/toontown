...
ITEM.model = "models/kingpommes/starwars/misc/droids/wed_15.mdl"
ITEM.price = 1000
ITEM.height = 3
ITEM.width = 2
ITEM.uniqueID = "wed"
...
ITEM.functions.Place = {
	onRun = function(item)
		...
		if (IsValid(scripted_ents.Get("nut_wed"):SpawnFunction(item.player, util.TraceLine(data)))) then
