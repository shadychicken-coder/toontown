...
function ENT:SpawnFunction( ply, tr, ClassName )
    ...
    local ent = ents.Create( "nut_tent" )
    ent:SetCreator( ply )
...
if (SERVER) then
	function ENT:Initialize()
		self:SetModel("models/starwars/syphadias/props/sw_tor/bioware_ea/props/republic/rep_tent_leanto.mdl")
